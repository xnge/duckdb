...
>>>>>>> 30eaf7599 (Add BatchCollector, collectors working now)
...
=======
	    make_unique<MaterializedQueryResult>(pending.statement_type, pending.types, pending.names, shared_from_this());
...
=======
=======
>>>>>>> 3f62006f0 (Fixes for pipeline execution & caching)
