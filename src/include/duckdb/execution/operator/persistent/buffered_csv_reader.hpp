...
>>>>>>> 022cd8162 (CSV reader prefeching for http files)
=======
>>>>>>> d2e051503 (reverted csv reader optimization for now)
...
<<<<<<< HEAD
	...
	idx_t skip_rows = 0;
=======
>>>>>>> c75a92b6b (unified csv options parsing from 'copy_csv' and 'read_csv' into their own dedicated methods in the BufferedCSVReaderOptions struct)
