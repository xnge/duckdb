...
>>>>>>> b80fbb6ac (Use shared_ptr for column statistics to avoid copying distinct statistics on ALTER TABLE)
	}
#endif
...
>>>>>>> c500eeb6b (starting work on handling the generated columns in the binder for a SELECT statement)
=======
=======
	for (auto &gen_column : generated_columns) {
>>>>>>> 8246b433a (StarExpression now includes all generated columns as well (and ran format-master))
		create_info->generated_columns.push_back(gen_column.Copy());
>>>>>>> 06a5a19c7 (fixed some compiler warnings)
	}
<<<<<<< HEAD
=======
>>>>>>> a0a440a0d (merge complete in alter table)
...
>>>>>>> 73401fd24 (made ColumnDefinition members private)
