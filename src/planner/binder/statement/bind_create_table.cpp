...
>>>>>>> 1981ce5a2 (working on the refactor, not functional in this state)
=======
	properties.allow_stream_result = false;
>>>>>>> 437d4506e (implicitly create and maintain CHECK constraint around generated column expression -> col.type)
	return result;
}
