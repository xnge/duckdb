...
>>>>>>> 501036521 (removed EXCLUDED_FROM_STORAGE_ID and removed changing of the category outside of SetGeneratedExpression)
		return column_id;
	}
...
>>>>>>> 8ad63e960 (storage_oid added and seems to be working for the most part)
	return move(result);
}
